require("emacsified.set")
require("emacsified.remap")

require("emacsified.lazy_init")
...
local EmacsifiedGroup = augroup('emacsified', {})
...
autocmd('LspAttach', {
    ...
    callback = function(e)
        ...
        vim.keymap.set("n", "<leader>vd", function() vim.diagnostic.open_float() end, opts, { desc = "Open diagnostic float" })
